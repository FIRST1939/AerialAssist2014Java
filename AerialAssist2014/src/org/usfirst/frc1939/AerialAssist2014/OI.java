...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("GetRoborealmVariableCommand", new GetRoborealmVariableCommand());
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        togglePhotoswitch = new JoystickButton(moveStick, 4);
        togglePhotoswitch.toggleWhenPressed(new PhotoswitchTestCommand());
        toggleGetRoborealm = new JoystickButton(moveStick, 5);
        toggleGetRoborealm.toggleWhenActive(new GetRoborealmVariableCommand());
