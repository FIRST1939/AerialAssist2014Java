...
public class Drivetrain extends Subsystem {
    ...
    */
    ...
    public double getYDistance(){
        return (leftRearEncoder.getDistance()+leftFrontEncoder.getDistance()+rightFrontEncoder.getDistance()+rightRearEncoder.getDistance())/4*slipFactorY;
    }
    
    //Left and Right
    public double getXDistance(){
        return (rightFrontEncoder.getDistance()-rightRearEncoder.getDistance()+leftFrontEncoder.getDistance()-leftRearEncoder.getDistance())/4*slipFactorX;
    }
    ...
    public double getDegrees(){
        ...
        double LR2 = leftRearEncoder.get()*((2*Math.PI)/360);
        double RF3 = rightFrontEncoder.get()*((2*Math.PI)/360);
        double RR4 = rightRearEncoder.get()*((2*Math.PI)/360);
