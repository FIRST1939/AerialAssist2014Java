...
public class OI {
    ...
    public OI() {
        ...
        wallsOutButton = new JoystickButton(rotateJoystick, 9);
        wallsOutButton.whenPressed(new WallsOut());
        wallsInButton = new JoystickButton(rotateJoystick, 11);
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        rollersIn = new JoystickButton(rotateJoystick, 12);
        rollersIn.toggleWhenPressed(new ToggleRollersIn());
        rollersOut = new JoystickButton(rotateJoystick, 10);
