...
public class RobotMap {
    ...
    public static AnalogChannel ultraSonicUltrasonicInput;
	...
	LiveWindow.addSensor("PhotoSwitch", "PhotoSwitch", photoSwitchPhotoSwitch);
        ...
        ultraSonicOutput = new DigitalOutput(1);
        
        ultraSonicUltrasonicInput = new AnalogChannel(1, 1);
	LiveWindow.addSensor("UltraSonic", "UltrasonicInput", ultraSonicUltrasonicInput);
