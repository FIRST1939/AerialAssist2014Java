...
public class OI {
    ...
    public OI() {
        ...
        shootButton = new JoystickButton(rotateStick, 2);
        shootButton.whenPressed(new ButtonPressed());
        moveStick = new Joystick(1);
        
        camera = new JoystickButton(moveStick, 3);
        camera.whenPressed(new CameraTarget());
	    
        // SmartDashboard Buttons
        SmartDashboard.putData("Autonomous Command", new AutonomousCommand());
        SmartDashboard.putData("DriveWithJoyStick", new DriveWithJoyStick());
        SmartDashboard.putData("Button Pressed", new ButtonPressed());
