...
public class RobotMap {
    ...
    public static DoubleSolenoid armright;
    public static DoubleSolenoid armleft;
    ...
    public static DigitalInput catapultkick;
    public static DigitalInput catapultdown;
    public static SpeedController catapultmotor;
    public static DoubleSolenoid catapultright;
    public static DoubleSolenoid catapultleft;
    public static Relay lightsspike1;
    public static Relay lightsspike2;
	...
	LiveWindow.addActuator("Arm", "motor", (Talon) armmotor);
        ...
        armright = new DoubleSolenoid(1, 1, 2);      
	
        
        armleft = new DoubleSolenoid(1, 3, 4);      
	...
	LiveWindow.addSensor("Walls", "in", wallsin);
        ...
        catapultkick = new DigitalInput(1, 14);
	LiveWindow.addSensor("Catapult", "kick", catapultkick);
        
        catapultdown = new DigitalInput(1, 9);
	LiveWindow.addSensor("Catapult", "down", catapultdown);
        
        catapultmotor = new Victor(1, 7);
	LiveWindow.addActuator("Catapult", "motor", (Victor) catapultmotor);
        
        catapultright = new DoubleSolenoid(1, 5, 6);      
	
        
        catapultleft = new DoubleSolenoid(1, 7, 8);      
	
        
        lightsspike1 = new Relay(1, 2);
	LiveWindow.addActuator("Lights", "spike1", lightsspike1);
        
        lightsspike2 = new Relay(1, 3);
	LiveWindow.addActuator("Lights", "spike2", lightsspike2);
