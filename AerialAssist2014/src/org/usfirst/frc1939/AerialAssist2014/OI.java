...
public class OI {
    ...
    public OI() {
        ...
        wallsOutButton2 = new JoystickButton(gamepad, 8);
        wallsOutButton2.whenPressed(new WallsOut());
        wallsInButton2 = new JoystickButton(gamepad, 7);
        wallsInButton2.whenPressed(new WallsIn());
        armOutButton2 = new JoystickButton(gamepad, 3);
        armOutButton2.whenPressed(new ArmOut());
        armInButton2 = new JoystickButton(gamepad, 1);
