 ...
 *
 */
public class  AutonomousTargetCommand extends Command {
    
    NetworkTable server;
    boolean targeted;
    int count;
    
    public AutonomousTargetCommand(String[] args) {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=REQUIRES
        ...
        this.setTimeout(Double.parseDouble(args[0]));
    }
    ...
    protected boolean isFinished() {
        return this.isTimedOut() || targeted;
    }
