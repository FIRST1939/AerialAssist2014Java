 ...
 *
 */
public class  WallsInCommand extends Command {
    public WallsInCommand() {
    ...
    protected void initialize() {
        System.out.println("Walls In Started");
    ...
    protected boolean isFinished() {
        System.out.println("In: " + !RobotMap.wallsin.get());
        System.out.println("Out: " + !RobotMap.wallsout.get());
        return !RobotMap.wallsin.get();
    }
    // Called once after isFinished returns true
    protected void end() {
        System.out.println("Walls In Stopped");
