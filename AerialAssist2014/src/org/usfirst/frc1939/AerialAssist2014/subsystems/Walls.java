...
public class Walls extends Subsystem {
    ...
    SpeedController motor = RobotMap.wallsMotor;
    DigitalInput inLimitSwitch = RobotMap.wallsInLimitSwitch;
    DigitalInput outLimitSwitch = RobotMap.wallsOutLimitSwitch;
